  ...
  return (
    <div className="relative w-full h-full transition-transform">
      ...
      <div className={`absolute top-0 w-8 h-8 ${color} rounded-full left-1 z-10 shadow-sm border-2 border-gray-900`}>
        ...
        {/* Headband tail */}
        <div className={`headband absolute top-2 -left-3 w-4 h-1.5 ${accent} rounded-l animate-pulse -rotate-12`}></div>
      </div>
      ...
      {/* Arms */}
      <div className={`absolute top-8 w-2 h-5 ${color} left-1 rotate-12 rounded-full border border-gray-900`}></div>
      <div className={`absolute top-8 w-2 h-5 ${color} left-7 -rotate-12 rounded-full border border-gray-900`}></div>
      
      {/* Legs */}
      <div className={`leg-l absolute top-13 w-2.5 h-5 ${color} left-2 rounded-full origin-top rotate-12 border border-gray-900`}></div>
      <div className={`leg-r absolute top-13 w-2.5 h-5 ${color} left-5.5 rounded-full origin-top -rotate-12 border border-gray-900`}></div>
